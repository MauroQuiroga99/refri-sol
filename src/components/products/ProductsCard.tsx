...
const ProductsCard = ({ products }: ProductsCardProps) => {
  return (
    <div className="  justify-center mx-auto">
      <div className="group border-gray-100/30 flex w-[293.9px] max-w-xs flex-col self-center overflow-hidden rounded-lg border bg-gray-700 shadow-md">
        <div className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl">
          <img
            className="peer absolute top-0 right-0 h-full w-full object-cover"
            src="https://images-na.ssl-images-amazon.com/images/I/71m3njCQ2QL._AC_UL232_SR232,232_.jpg"
            alt="product image"
          />
          <img
            ...
            src="https://m.media-amazon.com/images/I/71YfQuJDoXL._AC_SX569_.jpg"
            alt="product image"
          />
          <svg
        ...
        <div className="mt-4 px-5 pb-5">
          <a href="#">
            <h5 className="text-sm tracking-tight text-white">
